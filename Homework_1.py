    ...
    for y in range(2):
        for z in range(2):
            if not (x or y or z) == (not(x)) and not (y) and not (z):
                print(f"{x} {y} {z} Вырожение истинно")
            else:
                print(f"{x} {y} {z} Вырожение ложно")
...
if x < 0 and y < 0:
    ...
    print('Точка лежит на оси коорднат')


# 1. Напишите программу, которая по заданному номеру четверти, показывает диапазон возможных координат точек в этой четверти (х и у).
...
xa, ya = int(input('Введите координаты точки А: ')), int(input('Введите координаты точки А: '))
xb, yb = int(input('Введите координаты точки B: ')), int(input('Введите координаты точки B: '))
